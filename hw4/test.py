...
with open("results.txt", "w+") as f:
    ...
    print("=" * 100, file=f)
    for domain, query in [("restaurant", {"restaurant-area": "centre", "restaurant-pricerange": "cheap"}),
                          ("train", {"train-arriveby": "12pm", "train-departure": "cambridge", "train-day": "tuesday"}),
                          ("hotel", {"hotel-pricerange": "cheap", "hotel-area": "west", "hotel-internet": "yes", "hotel-type": "guesthouse"})]:
